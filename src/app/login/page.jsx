    ...
    <>
      <S.LoginMain>
        <S.LoginContainer className="container">
          <S.FormBox>
            <S.FormTitle>
              <span><Image src={GaulesTwo} alt="Emoji do Gaules dançando a cabecinha" width={28} height={28} /> </span>
              Bem-vindo novamente
            </S.FormTitle>
            <S.FormDescription>
              Digite seus dados de login para acessar a plataforma da <strong>Tribo Business</strong>
            </S.FormDescription>
            <S.FormLogin>
              <S.FormInputGroup>
              ...
              <S.FormInputGroup>
                <S.FormInputLabel htmlFor="senha">
                  Senha
                </S.FormInputLabel>
